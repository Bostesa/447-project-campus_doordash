  ...
  return (
    <div className="login-page">
      ...
      <p className="login-subtitle">
        Order food from campus dining, delivered to your dorm.
      </p>
      ...
      <div className="login-divider">
        <span>Welcome to DormDash</span>
      </div>

      <div className="login-features">
        <div className="feature-item">
          <span>Order from campus restaurants</span>
        </div>
        <div className="feature-item">
          <span>Fast delivery to your dorm</span>
        </div>
        <div className="feature-item">
